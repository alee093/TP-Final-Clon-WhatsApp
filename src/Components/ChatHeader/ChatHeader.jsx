...
const ChatHeader = () => {
    ...
    return (
        <header className='chat-header' onClick={() => {setInfo(true)}}>
            <img src={profile} alt="profile" className='chat-header-profile'/>
            <div className='chat-header-name-menu-container'>
                <div className='chat-header-name-icon'>
                ...
                <div className='chat-header-menu-container'>
                    <button className='chat-header-search'>
