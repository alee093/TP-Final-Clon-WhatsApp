        ...
        <div className='chat-search-container'>
            ...
            <div className='chat-search-input-container'>
                ...
                <form className='search-messages-form'>
                    ...
                    <button type='submit' className='search-messages-submit-button' onClick={(event) =>{ 
                    ...
                    <input type="text" placeholder='Buscar' autoComplete='off' name='searchMessagesInput' className='search-messages-input'
