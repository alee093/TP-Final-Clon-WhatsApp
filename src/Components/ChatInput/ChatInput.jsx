            ...
            <div className='chat-input'>
                ...
                <form className='chat-input-form' onSubmit={handleSubmit}>
                    ...
                    <button className='chat-send-button' type='submit'>
                        <svg viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" className='chat-send-icon' version="1.1" x="0px" y="0px"><path fill="#7b8b94" d="M1.101,21.757L23.8,12.028L1.101,2.3l0.011,7.912l13.623,1.816L1.112,13.845 L1.101,21.757z"></path></svg>
                    </button>
                </form>
            </div>
        </div>
