...
const ChatInput = () => {
    ...
    const handleSubmit = (event) => { 
        ...
        const message = event.target.input.value.trim()
        if (message === '') return
    ...
    return (
        <div className='chat-input-container'>
            ...
            <div className='chat-input'>
                <button className='chat-expressions-button' onClick={() => alert("Funcionalidad en desarrollo")}>
                ...
                <form className='chat-input-form' onSubmit={handleSubmit}>
                    ...
                    <input type="text" placeholder='Escribe un mensaje' className='input' name='input' autoComplete='off' defaultValue={firstMessage}/>
